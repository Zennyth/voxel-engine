...
uint16_t Biome::get_underground_color_at(float offset) {
    return get_color_at(_underground_gradient, offest);
}
uint16_t Biome::get_surface_color_at(float offset) {
    return get_color_at(_surface_gradient, offest);
}
...
void Biome::_bind_methods() {
    ...
    ClassDB::bind_method(D_METHOD("set_surface_threshold", "new_surface_threshold"), &VoxelGeneratorWorld::set_surface_threshold);
	ClassDB::bind_method(D_METHOD("get_surface_threshold"), &VoxelGeneratorWorld::get_surface_threshold);
